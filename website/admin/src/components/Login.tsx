          ...
          <form onSubmit={handleEmailMagicLink} className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <button
                type="submit"
                disabled={loading}
                className="bg-gradient-to-r from-cyan-500 to-purple-600 hover:opacity-90 text-white px-4 py-2.5 rounded-xl text-xs font-semibold whitespace-nowrap cursor-pointer transition-opacity"
              >
                Send Link
              </button>
            </div>
